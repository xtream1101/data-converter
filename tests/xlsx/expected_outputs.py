...
SHEET2 = {u"Price's super cool second sheet":
                 [{u'of ': True, u'glory': datetime.datetime(2018, 2, 20, 0, 0), u'blades': 47L},
                  {u'of ': False, u'glory': datetime.datetime(2018, 2, 20, 0, 0), u'blades': 12L},
                  {u'of ': True, u'glory': datetime.datetime(2018, 2, 20, 0, 0), u'blades': 18L}]}
...
HEADERLESS_SHEET1 = {u'Sheet1':
                  [[u'jedi', 1L, 12L, 124L,
                    datetime.datetime(2018, 2, 20, 0, 0), u'super rad', False],
                   [u'sith', 4L, 25L, 54L,
                    datetime.datetime(2018, 2, 20, 0, 0), u'hella cool', True],
                   [u'jedi', None, 55L, 45L,
                    datetime.datetime(2018, 2, 20, 0, 0), u'fly as shit', False],
                   [u'sith', None, 23L, 4L,
                    datetime.datetime(2018, 2, 20, 0, 0), u'dope to the max', True],
                   [u'jei', 1L, 51053L, 154L,
                    datetime.datetime(2018, 2, 20, 0, 0), u'wavy extream', False]]}
HEADERLESS_SHEET2= {u"Price's super cool second sheet":
                 [[True, datetime.datetime(2018, 2, 20, 0, 0), 47L],
                  [False, datetime.datetime(2018, 2, 20, 0, 0), 12L],
                  [True, datetime.datetime(2018, 2, 20, 0, 0), 18L]]}